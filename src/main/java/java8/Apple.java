...
/**
 * @author WuGYu
 * @date 2018/1/12 11:47 这也是策略模式的一个例子，将谓词抽象成多个独立的策略，可以适应更多的需求
 */
public class Apple {
  ...
  public static void main(String[] args) {
    ...
    for (Apple a : Apple.applesFilter(testApple, (Apple a) -> "green".equals(a.getAppleColor()))) {
      System.out.println(a.getAppleColor());
    }
    for (Apple a : Apple.applesFilter(testApple, (Apple a) -> a.getHeavyWeight() > 150)) {
